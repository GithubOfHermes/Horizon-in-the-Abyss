...
public class GridManager : MonoBehaviour
{
    ...
    public Vector3 GetEmptyPosition(Vector3 avoidPos)
    {
        Vector3 pos;
        do
        {
            ...
            pos = originPosition + new Vector3(x * cellSize, 0, z * cellSize);
        }
        while (Vector3.Distance(pos, avoidPos) < cellSize * 0.5f);
        return pos;
    }
}
